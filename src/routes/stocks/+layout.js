export const load = async (loadEvent) => {
	...
	const topGainingStockResponse = await fetch('http://localhost:4000/most-gaining-stock');
	const topLosingStockResponse = await fetch('http://localhost:4000/most-losing-stock');
